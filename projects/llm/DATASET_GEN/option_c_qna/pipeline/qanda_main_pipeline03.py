...
Note:
    This file is self-contained for the pipeline. It relies on:
        option_c_qna.configuration.cfg
        option_c_qna.configuration.logging_config.get_qna_log
        option_c_qna.configuration.pg_db_config.get_training_session
        option_c_qna.models
        option_c_qna.document_structure_extractor
        option_c_qna.qanda_db
"""
...
"""python -m option_c_qna.qanda_pipeline "E:\emtac\data\raw_documention\FB4-GENERAL\AFL31600 Overview.docx" --stage full --max-chunks 5 --num-questions 2
python -m option_c_qna.qanda_pipeline "path\to\doc.docx" --stage questions --similarity-threshold 0.75 --num-questions 4
python -m option_c_qna.qanda_pipeline "path\to\*_questions.jsonl" --stage answers --models flan,qwen
python -m option_c_qna.qanda_pipeline "path\to\*_answers.jsonl" --stage export --export-format orpo
python -m option_c_qna.qanda_pipeline "E:\emtac\data\raw_documention\FB4-GENERAL\AFL31600 Overview.docx" --stage full

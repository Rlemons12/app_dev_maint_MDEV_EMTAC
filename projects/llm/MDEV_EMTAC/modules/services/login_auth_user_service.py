...
class LoginAuthUserService:
    ...
    def create_user_login(
        ...
        # Assign user_login.id before storing it in Flask session.
        db_session.flush()
    ...
    def close_user_login(db_session, login_record_id: Optional[int]) -> bool:
        ...
        login_record = db_session.query(UserLogin).get(login_record_id)
    ...
    @staticmethod
    def touch_user_login(db_session, login_record_id: Optional[int]) -> bool:
        if not login_record_id:
            return False

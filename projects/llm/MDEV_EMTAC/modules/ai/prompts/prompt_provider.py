    ...
    def _assemble_prompt(
        *,
        ...
        parts.append(
            ...
            + "If the answer is found in the context, use the exact information.\n"
            + "If multiple values are present, choose the most specific one.\n"
            + "If the context does not contain the answer, say what is missing and give general guidance only if useful.\n"
            + "Do not repeat the question, context, prompt, chunk labels, document IDs, or scores.\n"
            + "\nFINAL ANSWER:\n"
        )
